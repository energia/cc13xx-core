...
public class ti_sysbios_rom
{
    ...
    void ROM$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.rom.ROM.CC2652", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC2652", 5));
        om.bind("ti.sysbios.rom.ROM.CC2652R2", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC2652R2", 6));
    }
